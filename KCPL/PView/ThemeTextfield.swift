...
class ThemeTextField: UITextField {
    ...
    required init?(coder aDecoder: NSCoder) {
        super.init(coder: aDecoder)
        if self.tag==101{
            self.backgroundColor = UIColor(red: 130/255, green: 130/255, blue: 130/255, alpha: 0.4)
        ...
        self.layer.borderColor = themeTextFeildBorderColor.cgColor
  ...
  class ThemeTextFieldCreateEvent: UITextField {
