...
#define MENU_DEFAULT_LANDSCAPE_SLIDE_OFFSET [[UIScreen mainScreen] bounds].size.height * 0.5
#define MENU_DEFAULT_PORTRAITE_SLIDE_OFFSET [[UIScreen mainScreen] bounds].size.width * 0.25
...
//    self.landscapeSlideOffset = MENU_DEFAULT_LANDSCAPE_SLIDE_OFFSET;
//    self.portraitSlideOffset = MENU_DEFAULT_PORTRAITE_SLIDE_OFFSET;
...
- (void)viewWillLayoutSubviews
{
    ...
    if (UIInterfaceOrientationIsLandscape([UIApplication sharedApplication].statusBarOrientation)) {
        self.landscapeSlideOffset = [[UIScreen mainScreen] bounds].size.width * 0.5;
        self.portraitSlideOffset = [[UIScreen mainScreen] bounds].size.height * 0.25;
    } else {
        self.landscapeSlideOffset = [[UIScreen mainScreen] bounds].size.height * 0.5;
        self.portraitSlideOffset = [[UIScreen mainScreen] bounds].size.width * 0.25;
    }
...
#pragma mark - Uncomment bellow line if u don't want to swipe to open and close
//    return NO;
